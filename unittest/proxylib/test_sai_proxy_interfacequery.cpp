...
TEST(libsaiproxy, sai_query_attribute_capability)
{
    EXPECT_EQ(SAI_STATUS_NOT_IMPLEMENTED, sai_query_attribute_capability(0,SAI_OBJECT_TYPE_NULL,0,0));
}

TEST(libsaiproxy, sai_query_attribute_enum_values_capability)
{
    EXPECT_EQ(SAI_STATUS_NOT_IMPLEMENTED, sai_query_attribute_enum_values_capability(0,SAI_OBJECT_TYPE_NULL,0,0));
}

TEST(libsaiproxy, sai_object_type_get_availability)
{
    EXPECT_EQ(SAI_STATUS_NOT_IMPLEMENTED, sai_object_type_get_availability(0,SAI_OBJECT_TYPE_NULL,0,0,0));
}

TEST(libsaiproxy, sai_dbg_generate_dump)
{
    EXPECT_EQ(SAI_STATUS_NOT_IMPLEMENTED, sai_dbg_generate_dump(nullptr));
}

TEST(libsaiproxy, sai_object_type_query)
{
    EXPECT_EQ(SAI_OBJECT_TYPE_NULL, sai_object_type_query(SAI_NULL_OBJECT_ID));
}

TEST(libsaiproxy, sai_switch_id_query)
{
...
TEST(libsaiproxy, sai_bulk_object_clear_stats)
{
...
TEST(libsaiproxy, sai_query_api_version)
{
