    ...
    m_timerWatchdog(cmd->m_watchdogWarnTimeSpan * WD_DELAY_FACTOR)
{
    ...
    m_sn.onIpsecPostStatus = std::bind(&NotificationHandler::onIpsecPostStatus, m_handler.get(), _1, _2);
    m_sn.onSwitchMacsecPostStatus = std::bind(&NotificationHandler::onSwitchMacsecPostStatus, m_handler.get(), _1, _2);
    m_sn.onSwitchIpsecPostStatus = std::bind(&NotificationHandler::onSwitchIpsecPostStatus, m_handler.get(), _1, _2);
